...
const SideBar = () => {
    ...
    const menuItems = [
        ...
        { name: 'Order Status', path: '/admin/order-status', icon: assets.order_icon },
        { name: 'Vendors', path: '/admin/vendors', icon: assets.product_list_icon },
        { name: 'Payouts', path: '/admin/payouts', icon: assets.order_icon },
    ];
